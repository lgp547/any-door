 ...
 **/
public class ParamListTest extends JPanel {
    ...
    public ParamListTest(Project project) {
...
//                        tableModel.refreshAll(ViewData.toViewData(data));
                        tableModel.refreshAll(List.of(new ViewData(false, 1L, newFile.getName(), newFile.getCanonicalPath())));
                    }
                }
            }
        });
    ...
    public static class ViewData {
        ...
        public ViewData(boolean selected, Long id, String name, String qualifiedName) {
        ...
        static final ColumnInfo<ViewData, ?>[] COLUMN_NAMES = new ColumnInfo[]{
                ...
                new ColumnInfo<ViewData, String>("方法名") {
                    ...
                    @Override
                    public String valueOf(ViewData viewData) {
                        return viewData.qualifiedName;
                    }

                    @Override
                    public void setValue(ViewData viewData, String value) {
                        viewData.qualifiedName = value;
                    }
