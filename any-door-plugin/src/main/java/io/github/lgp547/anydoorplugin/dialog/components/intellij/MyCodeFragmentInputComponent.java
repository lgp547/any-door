...
public class MyCodeFragmentInputComponent extends EvaluationInputComponent {
  private final MyXDebuggerExpressionEditor myMultilineEditor;
  private final ExpressionInputForm myMainForm = new ExpressionInputForm();
  private final String mySplitterProportionKey;

  public MyCodeFragmentInputComponent(final @NotNull Project project,
    ...
    myMultilineEditor = new MyXDebuggerExpressionEditor(project, editorsProvider, "evaluateCodeFragment", sourcePosition,
  ...
  public Document getDocument() {
    return myMultilineEditor.getDocument();
  }
}
